...
![Архитектура проекта](https://raw.githubusercontent.com/Decodum/airflow2/main/docs/architecture.png) 
*(Примечание: Добавьте вашу схему архитектуры, если она есть, иначе удалите этот блок)*
